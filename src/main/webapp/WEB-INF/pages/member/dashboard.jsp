...
<main class="flex-grow max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 pb-36">
    ...
    <c:if test="${param.success == 'subscribed'}">
        <div class="mb-6 px-4 py-3 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-xl backdrop-blur-md">
            <p class="font-medium text-sm">Successfully subscribed to the new plan!</p>
        </div>
    </c:if>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="bg-zinc-950 bg-opacity-50 border border-red-500/20 rounded-3xl p-6 text-center shadow-lg relative overflow-hidden">
                            ...
                            <a href="${pageContext.request.contextPath}/member/subscribe" class="inline-block px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-all shadow-lg hover:shadow-emerald-500/20 active:scale-95">View Plans</a>
                        </div>
                    </c:otherwise>
                </c:choose>
            </section>
