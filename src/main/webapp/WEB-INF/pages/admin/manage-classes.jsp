                ...
                <tbody class="divide-y divide-zinc-800/50 text-zinc-300">
                    <c:forEach items="${classes}" var="cls">
                        <tr class="hover:bg-zinc-800/30 transition-colors">
                            <td class="px-6 py-4 font-medium text-white">${cls.className}</td>
                            <td class="px-6 py-4 text-zinc-400">${cls.instructor}</td>
                            <td class="px-6 py-4 text-zinc-400">${cls.scheduleDate} <span class="bg-zinc-800 text-zinc-300 px-2 py-0.5 rounded ml-2 text-xs">${cls.scheduleTime}</span></td>
