                ...
                <tbody class="divide-y divide-zinc-800/50 text-zinc-300">
                    <c:forEach items="${plans}" var="plan">
                        <tr class="hover:bg-zinc-800/30 transition-colors">
                            ...
                            <td class="px-6 py-4 text-zinc-400">${plan.durationMonths} months</td>
                            <td class="px-6 py-4 text-zinc-200 font-semibold">$${plan.price}</td>
                            <td class="px-6 py-4 text-zinc-400 truncate max-w-[200px]" title="${plan.description}">
                                ${plan.description}
                            </td>
                            <td class="px-6 py-4">
