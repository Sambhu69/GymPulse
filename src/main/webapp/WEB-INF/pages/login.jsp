...
<head>
    ...
    <title>Login — GymPulse</title>
    <meta name="description" content="Login to your GymPulse account to manage memberships and classes.">
    <!-- Tailwind CSS CDN -->
...
<main class="flex-grow flex items-center justify-center p-6">
    <div class="w-full max-w-md bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-2xl shadow-2xl p-8 transform transition-all hover:scale-[1.01]">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input id="rememberMe" name="rememberMe" type="checkbox" value="true"
                           class="h-4 w-4 rounded border-zinc-800 bg-zinc-950 text-white focus:ring-zinc-700 transition-all cursor-pointer">
                    <label for="rememberMe" class="ml-2 block text-sm text-zinc-400 cursor-pointer hover:text-zinc-300">Remember me</label>
                </div>
            </div>
        ...
        <div class="mt-8 space-y-3 text-center text-sm text-zinc-500">
            <p><a href="${pageContext.request.contextPath}/forgot-password" class="hover:text-white transition-colors">Forgot Password?</a></p>
            <p>Don't have an account? <a href="${pageContext.request.contextPath}/register" class="text-white hover:underline transition-colors">Create Account</a></p>
        </div>
    </div>
</main>
